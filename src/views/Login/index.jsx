...
function Login({ setIsLoggedIn }) {
  ...
  return (
    <>
      {forgot && <div class="bg-indigo-900 text-center py-4 lg:px-4">
        <div class="p-2 bg-indigo-800 items-center  leading-none lg:rounded-full flex lg:inline-flex" role="alert">
          <input type="text" onChange={(e) => setEmailRecovery(e.target.value)} placeholder="Inserir Endereço de Email" class="w-full ml-2 mr-2 px-4 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required />
          <span onClick={sendEmail} class="flex text-indigo-100 rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">Recuperar</span>
        </div>
      </div>}
      {alert == 'error' ? (
        <div role="alert">
          ...
          <div class="w-full h-100 ">
            ...
            <form class="mt-6" action="#" method="POST">
              ...
              <div class="text-right mt-2">
                <button onClick={(e) => handleForgot(e)} class="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Esqueceu sua senha?</button>
              </div>
