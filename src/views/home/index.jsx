...
export default function Home() {
  ...
  async function getDatas() {
    ...
    try {
      const [users, companies] = await Promise.all([
        ...
        Api.get('/companies/recover/companies', { params: { managerId: adminObj.id } })
      ]);
      setUsers(users.data)
  ...
  return (
    ...
    <div className=" bg-primary text-primary h-screen flex overflow-hidden text-sm">
      <ThemeProvider>
        ...
        <div className=" bg-primary text-primary w-20 flex-shrink-0 border-r border-gray-800 flex-col hidden sm:flex">
          ...
          <div className="flex mx-auto flex-grow mt-4 flex-col text-primary space-y-4">
            <button className="h-10 w-12 bg-primary text-primary rounded-md flex items-center justify-center">
            ...
            <button className="h-10 w-12 bg-quaternary text-primary rounded-md flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="h-5" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex-grow overflow-hidden h-full flex flex-col">
          <div className="h-16 lg:flex w-full border-b border-gray-800 hidden px-10">
            ...
            <div className="ml-auto bg-primary text-primary flex items-center space-x-7">
              <Toggle />
              {showConfig && <Config onClose={handleConfig} showModal={showConfig} companyId={companieIdSelect} />}
              <button className="flex items-center " onClick={() => setOpenPerfil(!openPerfil)}>
              ...
              {openPerfil && <Perfil showModal={openPerfil} onClose={handleopenPerfil} admin={adminObj} />}
              <div onClick={handleConfig}>
                <svg className="cursor-pointer w-4 h-4 m-4 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M1 5h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 1 0 0-2H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2Zm18 4h-1.424a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2h10.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Zm0 6H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 0 0 0 2h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Z" />
                </svg>

              </div>
              <svg onClick={() => handleLogin()} className="cursor-pointer w-4 h-4 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
          ...
          <div className="flex-grow flex overflow-x-hidden">
            <div className="xl:w-72 w-48 flex-shrink-0 border-r bg-primary text-primary border-gray-800 h-full overflow-y-auto lg:block hidden p-5">
              {users == "Sem usuários" ? (
                <div className="text-xs bg-primary text-primary tracking-wider">Usuários cadastrados: 0</div>
              ) : (
              ...
              <div className="space-y-4 mt-3">
                {users.length == 0 ? (
                  <div className="text-center">
                    <div role="status">
                      <svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-primary fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="text-xs text-center text-primary tracking-wider"> - Sem usuários no Aplicativo - </div>
                ) : null}
