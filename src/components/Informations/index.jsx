    ...
    <Dialog as="div" className="relative z-10" onClose={onClose}>
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto ">
        <div className="flex min-h-full min-w-lg items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl m-4 transition-all sm:my-8 sm:w-full min-w-lg">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <span className="font-semibold">Ambiente:</span> {datas.where}
                </Dialog.Title>
                <div className="mt-2">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    <span className="font-semibold"></span> {object.object.name}
                  </p>
                </div>
                  )
                })}
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button
                  type="button"
                  className="mt-3 inline-flex w-full justify-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                  onClick={handleExclusion} // Use a função de fechamento aqui
                  ref={cancelButtonRef}
                >
                  Deletar
                </button>
